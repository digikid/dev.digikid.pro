...
<template>
  <header
    class="header lg:fixed top-0 left-0 w-full lg:w-[320px] lg:h-full flex flex-col z-[2]"
  >
    <div class="header-panel fixed top-0 left-0 lg:static z-[99] w-full flex items-center justify-between bg-neutral-100 dark:bg-neutral-900 sm:px-4 sm:py-2 lg:p-8 lg:px-[42px]">
      <HeaderHeading />
      <HeaderHamburger
    ...
    <div
      ref="$main"
      class="header-main fixed top-0 left-0 lg:static pointer-events-none lg:pointer-events-auto z-[98] flex pt-16 lg:pt-0 w-full h-full lg:h-auto opacity-0 lg:opacity-100 grow flex-col text-center overflow-y-auto no-scrollbar lg:text-left bg-white dark:bg-dusky-900"
    >
      <HeaderNav />
      <HeaderFooter />
    </div>
